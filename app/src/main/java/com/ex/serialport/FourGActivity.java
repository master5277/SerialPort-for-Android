...
public class FourGActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_four_gactivity);
        recy = (RecyclerView) findViewById(R.id.fourgrecyclerView);//实例化recyclerView控件
        spSerial = (Spinner) findViewById(R.id.fourgsp_serial);//实例化串口下拉框
        edInput = (EditText) findViewById(R.id.fourged_input);//实例化编辑框
        btSend = (Button) findViewById(R.id.fourgbtn_send);//实例化发送按钮
        spBote = (Spinner) findViewById(R.id.fourgsp_baudrate);//实例化波特率下拉框
        btOpen = (Button) findViewById(R.id.fourgbtn_open);//实例化打开按钮

        radioGroup = (RadioGroup) findViewById(R.id.fourgradioGroup);//实例化单按钮集合
        radioButton1 = (RadioButton) findViewById(R.id.fourgradioButton1);//实例化单选按钮1Text
        radioButton2 = (RadioButton) findViewById(R.id.fourgradioButton2);//实例化单选按钮2Hex

        spDatab = (Spinner) findViewById(R.id.fourgsp_databits);//实例化数据位下拉框
        spParity = (Spinner) findViewById(R.id.fourgsp_parity);//实例化校验位下拉框
        spStopb = (Spinner) findViewById(R.id.fourgsp_stopbits);//实例化停止位下拉框
        spFlowcon = (Spinner) findViewById(R.id.fourgsp_flowcon);//实例化流控位下拉框
        ...
        btOpen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Toast.makeText(FourGActivity.this, "msg: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    e.printStackTrace();
                } catch (SecurityException ex) {
                    Toast.makeText(FourGActivity.this, "msg: " + ex.getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        });
